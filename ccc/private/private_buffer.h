...
#define CCC_private_buffer_from(private_alloc_fn, private_context_data,        \
...
#define CCC_private_buffer_with_capacity(                                      \
    private_any_type_name, private_alloc_fn, private_context_data,             \
    private_capacity)                                                          \
    (__extension__({                                                           \
        struct CCC_Buffer private_buf = CCC_private_buffer_initialize(         \
            NULL, private_any_type_name, private_alloc_fn,                     \
            private_context_data, 0);                                          \
