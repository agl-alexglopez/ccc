...
void *ccc_sll_push_front(ccc_singly_linked_list *fl,
                         ccc_sll_elem *struct_handle);
void *ccc_sll_front(ccc_singly_linked_list const *fl);
void ccc_sll_pop_front(ccc_singly_linked_list *fl);

bool ccc_sll_validate(ccc_singly_linked_list const *fl);
