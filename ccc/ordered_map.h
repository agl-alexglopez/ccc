...
@return an input error if om points to nullptr otherwise OK.
...
@param [in] om the map.
@return true if empty else false. Error if om is nullptr. */
[[nodiscard]] ccc_tribool ccc_om_is_empty(ccc_ordered_map const *om);

/** @brief Returns the size of the map.
@param [in] om the map.
@return the size or an argument error is set if om is nullptr. */
