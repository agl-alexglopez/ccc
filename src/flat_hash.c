...
ccc_result
ccc_fh_init(ccc_fhash *const h, ccc_buf *const buf, size_t key_offset,
...
{
    if (!(h.impl.entry.status & CCC_ENTRY_OCCUPIED))
    {
        return NULL;
    }
