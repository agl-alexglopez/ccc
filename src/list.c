...
void *
ccc_l_push_front(ccc_list *l, ccc_list_elem *struct_handle)
{
    if (l->impl.fn)
    {
    ...
    ccc_impl_l_push_front(&l->impl, &struct_handle->impl);
    return struct_base(&l->impl, l->impl.sentinel.n);
}

void *
ccc_l_push_back(ccc_list *l, ccc_list_elem *struct_handle)
{
    if (l->impl.fn)
    {
        void *node = l->impl.fn(NULL, l->impl.elem_sz);
    ...
    ccc_impl_l_push_back(&l->impl, &struct_handle->impl);
    return struct_base(&l->impl, l->impl.sentinel.p);
}

void *
ccc_l_front(ccc_list const *l)
{
    if (!l->impl.sz)
    {
        return NULL;
...
void
ccc_impl_l_push_back(struct ccc_impl_list *const l,
...
void
ccc_impl_l_push_front(struct ccc_impl_list *const l,
                      struct ccc_impl_list_elem *const e)
{
    e->p = &l->sentinel;
    e->n = l->sentinel.n;
...
void
ccc_l_splice(ccc_list_elem *pos, ccc_list_elem *const to_cut)
{
...
void *
ccc_l_begin(ccc_list const *const l)
{
...
void *
ccc_l_next(ccc_list const *const l, ccc_list_elem const *e)
{
...
size_t
ccc_l_size(ccc_list const *const l)
{
    return l->impl.sz;
}

bool
ccc_l_validate(ccc_list const *const l)
{
    size_t size = 0;
...
ccc_impl_elem_in(struct ccc_impl_list const *const l,
