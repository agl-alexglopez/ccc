...
pq_test_priority_valid_range(void)
{
    ...
    const struct pq_rrange rev_range = pq_equal_rrange(&pq, &b.elem, &e.elem);
    ...
    const struct pq_range range = pq_equal_range(&pq, &b.elem, &e.elem);
