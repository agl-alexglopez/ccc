...
check_static_begin(ordered_map_test_insert_macros)
{
    CCC_Ordered_map om = ordered_map_initialize(om, struct Val, elem, key,
    ...
    check_end(CCC_ordered_map_clear(&om, NULL););
}

check_static_begin(ordered_map_test_insert_overwrite)
{
    CCC_Ordered_map om = ordered_map_initialize(om, struct Val, elem, key,
                                                id_order, NULL, NULL);
...
check_static_begin(ordered_map_test_insert_then_bad_ideas)
{
    CCC_Ordered_map om = ordered_map_initialize(om, struct Val, elem, key,
                                                id_order, NULL, NULL);
    struct Val q = {.key = 137, .val = 99};
...
check_static_begin(ordered_map_test_entry_api_functional)
{
    ...
    check(count(&om).count, (size / 2));
    check_end(ordered_map_clear(&om, NULL););
}

check_static_begin(ordered_map_test_insert_via_entry)
{
    /* Over allocate size now because we don't want to worry about resizing. */
    size_t const size = 200;
    CCC_Ordered_map om = ordered_map_initialize(om, struct Val, elem, key,
...
check_static_begin(ordered_map_test_insert_via_entry_macros)
{
    /* Over allocate size now because we don't want to worry about resizing. */
    size_t const size = 200;
    CCC_Ordered_map om = ordered_map_initialize(om, struct Val, elem, key,
...
check_static_begin(ordered_map_test_entry_api_macros)
{
    /* Over allocate size now because we don't want to worry about resizing. */
    int const size = 200;
    CCC_Ordered_map om = ordered_map_initialize(om, struct Val, elem, key,
...
check_static_begin(ordered_map_test_two_sum)
{
    CCC_Ordered_map om = ordered_map_initialize(om, struct Val, elem, key,
                                                id_order, std_allocate, NULL);
...
check_static_begin(ordered_map_test_resize)
{
    CCC_Ordered_map om = ordered_map_initialize(om, struct Val, elem, key,
                                                id_order, std_allocate, NULL);
...
check_static_begin(ordered_map_test_resize_macros)
{
    CCC_Ordered_map om = ordered_map_initialize(om, struct Val, elem, key,
                                                id_order, std_allocate, NULL);
    int const to_insert = 1000;
...
check_static_begin(ordered_map_test_resize_fordered_map_null)
{
    CCC_Ordered_map om = ordered_map_initialize(om, struct Val, elem, key,
                                                id_order, std_allocate, NULL);
    int const to_insert = 1000;
...
check_static_begin(ordered_map_test_resize_fordered_map_null_macros)
{
    CCC_Ordered_map om = ordered_map_initialize(om, struct Val, elem, key,
                                                id_order, std_allocate, NULL);
    int const to_insert = 1000;
...
check_static_begin(ordered_map_test_insert_and_find)
{
    int const size = 101;
    CCC_Ordered_map om = ordered_map_initialize(om, struct Val, elem, key,
                                                id_order, std_allocate, NULL);
...
check_static_begin(ordered_map_test_insert_shuffle)
{
...
check_static_begin(ordered_map_test_insert_weak_srand)
{
