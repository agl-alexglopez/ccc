...
CHECK_BEGIN_STATIC_FN(check_range, Ordered_map const *const rom,
...
CHECK_BEGIN_STATIC_FN(check_rrange, Ordered_map const *const rom,
...
CHECK_BEGIN_STATIC_FN(ordered_map_test_forward_iter)
{
...
CHECK_BEGIN_STATIC_FN(ordered_map_test_iterate_removal)
{
    CCC_Ordered_map s = CCC_ordered_map_initialize(s, struct Val, elem, key,
                                                   id_order, NULL, NULL);
...
CHECK_BEGIN_STATIC_FN(ordered_map_test_iterate_remove_reinsert)
{
    CCC_Ordered_map s = CCC_ordered_map_initialize(s, struct Val, elem, key,
                                                   id_order, NULL, NULL);
    /* Seed the test with any integer for reproducible random test sequence
...
CHECK_BEGIN_STATIC_FN(ordered_map_test_valid_range)
{
    CCC_Ordered_map s = CCC_ordered_map_initialize(s, struct Val, elem, key,
                                                   id_order, NULL, NULL);
...
CHECK_BEGIN_STATIC_FN(ordered_map_test_valid_range_equals)
{
    CCC_Ordered_map s = CCC_ordered_map_initialize(s, struct Val, elem, key,
                                                   id_order, NULL, NULL);
...
CHECK_BEGIN_STATIC_FN(ordered_map_test_invalid_range)
{
    CCC_Ordered_map s = CCC_ordered_map_initialize(s, struct Val, elem, key,
                                                   id_order, NULL, NULL);
    int const num_nodes = 25;
...
CHECK_BEGIN_STATIC_FN(ordered_map_test_empty_range)
{
    CCC_Ordered_map s = CCC_ordered_map_initialize(s, struct Val, elem, key,
                                                   id_order, NULL, NULL);
    int const num_nodes = 25;
