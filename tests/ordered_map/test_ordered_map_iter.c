...
check_static_begin(check_range, Ordered_map const *const rom,
...
check_static_begin(check_range_reverse, Ordered_map const *const rom,
...
check_static_begin(iterator_check, CCC_Ordered_map *s)
{
...
check_static_begin(ordered_map_test_forward_iter)
{
...
check_static_begin(ordered_map_test_iterate_removal)
{
    CCC_Ordered_map s = CCC_ordered_map_initialize(s, struct Val, elem, key,
                                                   id_order, NULL, NULL);
...
check_static_begin(ordered_map_test_iterate_remove_reinsert)
{
    CCC_Ordered_map s = CCC_ordered_map_initialize(s, struct Val, elem, key,
                                                   id_order, NULL, NULL);
    /* Seed the test with any integer for reproducible random test sequence
...
check_static_begin(ordered_map_test_valid_range)
{
    CCC_Ordered_map s = CCC_ordered_map_initialize(s, struct Val, elem, key,
                                                   id_order, NULL, NULL);
...
check_static_begin(ordered_map_test_valid_range_equals)
{
    CCC_Ordered_map s = CCC_ordered_map_initialize(s, struct Val, elem, key,
                                                   id_order, NULL, NULL);
...
check_static_begin(ordered_map_test_invalid_range)
{
    CCC_Ordered_map s = CCC_ordered_map_initialize(s, struct Val, elem, key,
                                                   id_order, NULL, NULL);
    int const num_nodes = 25;
...
check_static_begin(ordered_map_test_empty_range)
{
    CCC_Ordered_map s = CCC_ordered_map_initialize(s, struct Val, elem, key,
                                                   id_order, NULL, NULL);
    int const num_nodes = 25;
...
{
    return check_run(
        ordered_map_test_forward_iter(), ordered_map_test_iterate_removal(),
        ordered_map_test_valid_range(), ordered_map_test_invalid_range(),
        ordered_map_test_valid_range_equals(), ordered_map_test_empty_range(),
        ordered_map_test_iterate_remove_reinsert());
}
