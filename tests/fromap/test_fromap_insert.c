...
BEGIN_STATIC_TEST(fromap_test_insert_one)
{
...
BEGIN_STATIC_TEST(fromap_test_insert_macros)
{
...
BEGIN_STATIC_TEST(fromap_test_insert_shuffle)
{
...
BEGIN_STATIC_TEST(fromap_test_insert_weak_srand)
{
...
main()
{
    return RUN_TESTS(fromap_test_insert_one(), fromap_test_insert_macros(),
