...
{
    flat_realtime_ordered_map s = frm_init((struct val[34]){}, 34, struct val,
...
{
    flat_realtime_ordered_map s = frm_init(
...
{
    flat_realtime_ordered_map s = frm_init((struct val[26]){}, 26, struct val,
                                           elem, id, NULL, val_cmp, NULL);
