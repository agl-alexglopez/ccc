...
CHECK_BEGIN_STATIC_FN(hromap_test_or_insert)
{
    ccc_handle_realtime_ordered_map hrm
        = hrm_init((struct val[33]){}, elem, id, id_cmp, NULL, NULL, 33);
    int size = 30;
    struct val *v = or_insert(handle_r(&hrm, &(int){-1}),
    ...
    CHECK(v->val, -1);
    CHECK(size(&hrm), 1);
    v = or_insert(handle_r(&hrm, &(int){-1}),
    ...
    i += (size / 2);
    v = or_insert(handle_r(&hrm, &i), &(struct val){.id = i, .val = i}.elem);
    CHECK(validate(&hrm), true);
    CHECK(v != NULL, true);
    CHECK(v->id, i);
    CHECK(v->val, i);
    CHECK(size(&hrm), i + 2);
    v = or_insert(handle_r(&hrm, &i),
...
CHECK_BEGIN_STATIC_FN(hromap_test_or_insert_with)
{
    ccc_handle_realtime_ordered_map hrm
        = hrm_init((struct val[33]){}, elem, id, id_cmp, NULL, NULL, 33);
    int size = 30;
    struct val *v = hrm_or_insert_w(handle_r(&hrm, &(int){-1}), idval(-1, -1));
    CHECK(validate(&hrm), true);
    CHECK(v != NULL, true);
    CHECK(v->id, -1);
    CHECK(v->val, -1);
    CHECK(size(&hrm), 1);
    v = hrm_or_insert_w(handle_r(&hrm, &(int){-1}), idval(-1, -2));
    CHECK(v != NULL, true);
    CHECK(v->id, -1);
    CHECK(v->val, -1);
    CHECK(size(&hrm), 1);
    ...
    i += (size / 2);
    v = hrm_or_insert_w(handle_r(&hrm, &i), idval(i, i));
    CHECK(validate(&hrm), true);
    CHECK(v != NULL, true);
    CHECK(v->id, i);
    CHECK(v->val, i);
    CHECK(size(&hrm), i + 2);
    v = hrm_or_insert_w(handle_r(&hrm, &i), idval(i, i + 1));
    CHECK(v != NULL, true);
    CHECK(v->id, i);
    CHECK(v->val, i);
    CHECK(size(&hrm), i + 2);
...
CHECK_BEGIN_STATIC_FN(hromap_test_insert_handle)
{
    ccc_handle_realtime_ordered_map hrm
        = hrm_init((struct val[33]){}, elem, id, id_cmp, NULL, NULL, 33);
    int size = 30;
    struct val *v = insert_handle(handle_r(&hrm, &(int){-1}),
                                  &(struct val){.id = -1, .val = -1}.elem);
    CHECK(validate(&hrm), true);
    CHECK(v != NULL, true);
    CHECK(v->id, -1);
    CHECK(v->val, -1);
    CHECK(size(&hrm), 1);
    v = insert_handle(handle_r(&hrm, &(int){-1}),
                      &(struct val){.id = -1, .val = -2}.elem);
    CHECK(v != NULL, true);
    CHECK(v->id, -1);
    CHECK(v->val, -2);
    ...
    i += (size / 2);
    v = insert_handle(handle_r(&hrm, &i),
...
CHECK_BEGIN_STATIC_FN(hromap_test_insert_handle_with)
{
    ...
    int size = 30;
    struct val *v
        = hrm_insert_handle_w(handle_r(&hrm, &(int){-1}), idval(-1, -1));
    CHECK(validate(&hrm), true);
    CHECK(v != NULL, true);
    CHECK(v->id, -1);
    CHECK(v->val, -1);
    CHECK(size(&hrm), 1);
    v = hrm_insert_handle_w(handle_r(&hrm, &(int){-1}), idval(-1, -2));
    CHECK(v != NULL, true);
    CHECK(v->id, -1);
    CHECK(v->val, -2);
    CHECK(size(&hrm), 1);
    ...
    i += (size / 2);
    v = hrm_insert_handle_w(handle_r(&hrm, &i), idval(i, i));
    CHECK(validate(&hrm), true);
    CHECK(v != NULL, true);
    CHECK(v->id, i);
    CHECK(v->val, i);
    CHECK(size(&hrm), i + 2);
    v = hrm_insert_handle_w(handle_r(&hrm, &i), idval(i, i + 1));
    CHECK(v != NULL, true);
    CHECK(v->id, i);
    CHECK(v->val, i + 1);
    CHECK(size(&hrm), i + 2);
