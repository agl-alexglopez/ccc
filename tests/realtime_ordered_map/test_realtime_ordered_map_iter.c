...
check_static_begin(check_range, Realtime_ordered_map const *const rom,
...
check_static_begin(iterator_check, Realtime_ordered_map *s)
{
...
check_static_begin(realtime_ordered_map_test_forward_iter)
{
    Realtime_ordered_map s = realtime_ordered_map_initialize(
...
check_static_begin(realtime_ordered_map_test_iterate_removal)
{
    Realtime_ordered_map s = realtime_ordered_map_initialize(
        s, struct Val, elem, key, id_order, NULL, NULL);
...
check_static_begin(realtime_ordered_map_test_iterate_remove_reinsert)
{
    Realtime_ordered_map s = realtime_ordered_map_initialize(
        s, struct Val, elem, key, id_order, NULL, NULL);
    /* Seed the test with any integer for reproducible random test sequence
...
check_static_begin(realtime_ordered_map_test_valid_range)
{
    Realtime_ordered_map s = realtime_ordered_map_initialize(
        s, struct Val, elem, key, id_order, NULL, NULL);
...
check_static_begin(realtime_ordered_map_test_valid_range_equals)
{
    Realtime_ordered_map s = realtime_ordered_map_initialize(
        s, struct Val, elem, key, id_order, NULL, NULL);
...
check_static_begin(realtime_ordered_map_test_invalid_range)
{
    Realtime_ordered_map s = realtime_ordered_map_initialize(
        s, struct Val, elem, key, id_order, NULL, NULL);
    int const num_nodes = 25;
...
check_static_begin(realtime_ordered_map_test_empty_range)
{
    Realtime_ordered_map s = realtime_ordered_map_initialize(
        s, struct Val, elem, key, id_order, NULL, NULL);
    int const num_nodes = 25;
...
main()
{
    return check_run(realtime_ordered_map_test_forward_iter(),
                     realtime_ordered_map_test_iterate_removal(),
                     realtime_ordered_map_test_valid_range(),
                     realtime_ordered_map_test_valid_range_equals(),
                     realtime_ordered_map_test_invalid_range(),
                     realtime_ordered_map_test_empty_range(),
                     realtime_ordered_map_test_iterate_remove_reinsert());
}
