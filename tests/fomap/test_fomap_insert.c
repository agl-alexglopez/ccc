...
CHECK_BEGIN_STATIC_FN(fomap_test_insert)
{
    ccc_flat_ordered_map fom
        = fom_init((struct val[10]){}, elem, id, NULL, id_cmp, NULL, 10);
...
CHECK_BEGIN_STATIC_FN(fomap_test_entry_api_functional)
{
    ...
    ccc_flat_ordered_map fom
        = fom_init((struct val[200]){}, elem, id, NULL, id_cmp, NULL, 200);
...
{
    ccc_flat_ordered_map fom
        = fom_init((struct val[20]){}, elem, id, NULL, id_cmp, NULL, 20);
...
CHECK_BEGIN_STATIC_FN(fomap_test_insert_limit)
{
    int const size = 101;
    ccc_flat_ordered_map fom
        = fom_init((struct val[101]){}, elem, id, NULL, id_cmp, NULL, 101);
...
CHECK_BEGIN_STATIC_FN(fomap_test_insert_shuffle)
{
    ...
    ccc_flat_ordered_map s
        = fom_init((struct val[51]){}, elem, id, NULL, id_cmp, NULL, 51);
    CHECK(size > 1, true);
    int const prime = 53;
