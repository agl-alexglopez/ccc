...
static flat_hash_map static_fh
    = fhm_init(s_vals, e, key, NULL, fhmap_int_to_u64, fhmap_id_eq, NULL,
...
{
    flat_hash_map src = fhm_init((struct val[11]){}, e, key, NULL,
                                 fhmap_int_zero, fhmap_id_eq, NULL, 11);
    flat_hash_map dst = fhm_init((struct val[13]){}, e, key, NULL,
                                 fhmap_int_zero, fhmap_id_eq, NULL, 13);
...
CHECK_BEGIN_STATIC_FN(fhmap_test_copy_no_alloc_fail)
{
    flat_hash_map src = fhm_init((struct val[11]){}, e, key, NULL,
                                 fhmap_int_zero, fhmap_id_eq, NULL, 11);
    flat_hash_map dst = fhm_init((struct val[7]){}, e, key, NULL,
                                 fhmap_int_zero, fhmap_id_eq, NULL, 7);
    (void)insert(&src, &(struct val){.key = 0}.e);
    (void)insert(&src, &(struct val){.key = 1, .val = 1}.e);
    (void)insert(&src, &(struct val){.key = 2, .val = 2}.e);
    CHECK(size(&src), 3);
...
{
    flat_hash_map src = fhm_init((struct val *)NULL, e, key, std_alloc,
                                 fhmap_int_zero, fhmap_id_eq, NULL, 0);
    flat_hash_map dst = fhm_init((struct val *)NULL, e, key, std_alloc,
                                 fhmap_int_zero, fhmap_id_eq, NULL, 0);
    (void)insert(&src, &(struct val){.key = 0}.e);
    (void)insert(&src, &(struct val){.key = 1, .val = 1}.e);
    (void)insert(&src, &(struct val){.key = 2, .val = 2}.e);
...
{
    struct val vals[5] = {};
    flat_hash_map fh = fhm_init(vals, key, e, NULL, fhmap_int_zero, fhmap_id_eq,
...
{
    flat_hash_map fh = fhm_init((struct val[5]){}, e, key, NULL, fhmap_int_zero,
                                fhmap_id_eq, NULL, 5);
    CHECK(is_empty(&fh), true);
    struct val def = {.key = 137, .val = 0};
