...
check_static_begin(adaptive_map_test_forward_iter)
{
...
{
    return check_run(
        adaptive_map_test_forward_iter(), adaptive_map_test_iterate_removal(),
        adaptive_map_test_valid_range(), adaptive_map_test_invalid_range(),
