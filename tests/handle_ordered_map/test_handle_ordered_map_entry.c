...
check_static_begin(fill_n, CCC_Handle_ordered_map *const handle_ordered_map,
...
check_static_begin(handle_ordered_map_test_validate)
{
...
check_static_begin(handle_ordered_map_test_insert)
{
    ...
    check(fill_n(&handle_ordered_map, size / 2, i), CHECK_PASS);
    ...
    check(fill_n(&handle_ordered_map, size - i, i), CHECK_PASS);
...
check_static_begin(handle_ordered_map_test_remove)
{
    CCC_Handle_ordered_map handle_ordered_map
        = handle_ordered_map_initialize(&(small_fixed_map){}, struct Val, id,
                                        id_order, NULL, NULL, SMALL_FIXED_CAP);
...
check_static_begin(handle_ordered_map_test_try_insert)
{
    CCC_Handle_ordered_map handle_ordered_map
        = handle_ordered_map_initialize(&(small_fixed_map){}, struct Val, id,
                                        id_order, NULL, NULL, SMALL_FIXED_CAP);
...
check_static_begin(handle_ordered_map_test_try_insert_with)
{
    CCC_Handle_ordered_map handle_ordered_map
        = handle_ordered_map_initialize(&(small_fixed_map){}, struct Val, id,
                                        id_order, NULL, NULL, SMALL_FIXED_CAP);
...
check_static_begin(handle_ordered_map_test_insert_or_assign)
{
    CCC_Handle_ordered_map handle_ordered_map
        = handle_ordered_map_initialize(&(small_fixed_map){}, struct Val, id,
                                        id_order, NULL, NULL, SMALL_FIXED_CAP);
...
check_static_begin(handle_ordered_map_test_insert_or_assign_with)
{
    CCC_Handle_ordered_map handle_ordered_map
        = handle_ordered_map_initialize(&(small_fixed_map){}, struct Val, id,
                                        id_order, NULL, NULL, SMALL_FIXED_CAP);
...
check_static_begin(handle_ordered_map_test_handle_and_modify)
{
    CCC_Handle_ordered_map handle_ordered_map
        = handle_ordered_map_initialize(&(small_fixed_map){}, struct Val, id,
                                        id_order, NULL, NULL, SMALL_FIXED_CAP);
...
check_static_begin(handle_ordered_map_test_handle_and_modify_context)
{
    CCC_Handle_ordered_map handle_ordered_map
        = handle_ordered_map_initialize(&(small_fixed_map){}, struct Val, id,
                                        id_order, NULL, NULL, SMALL_FIXED_CAP);
...
check_static_begin(handle_ordered_map_test_handle_and_modify_with)
{
    CCC_Handle_ordered_map handle_ordered_map
        = handle_ordered_map_initialize(&(small_fixed_map){}, struct Val, id,
                                        id_order, NULL, NULL, SMALL_FIXED_CAP);
...
check_static_begin(handle_ordered_map_test_or_insert)
{
    CCC_Handle_ordered_map handle_ordered_map
        = handle_ordered_map_initialize(&(small_fixed_map){}, struct Val, id,
                                        id_order, NULL, NULL, SMALL_FIXED_CAP);
...
check_static_begin(handle_ordered_map_test_or_insert_with)
{
    CCC_Handle_ordered_map handle_ordered_map
        = handle_ordered_map_initialize(&(small_fixed_map){}, struct Val, id,
                                        id_order, NULL, NULL, SMALL_FIXED_CAP);
...
check_static_begin(handle_ordered_map_test_insert_handle)
{
    CCC_Handle_ordered_map handle_ordered_map
        = handle_ordered_map_initialize(&(small_fixed_map){}, struct Val, id,
                                        id_order, NULL, NULL, SMALL_FIXED_CAP);
...
check_static_begin(handle_ordered_map_test_insert_handle_with)
{
    CCC_Handle_ordered_map handle_ordered_map
        = handle_ordered_map_initialize(&(small_fixed_map){}, struct Val, id,
                                        id_order, NULL, NULL, SMALL_FIXED_CAP);
...
check_static_begin(handle_ordered_map_test_remove_handle)
{
    CCC_Handle_ordered_map handle_ordered_map
        = handle_ordered_map_initialize(&(small_fixed_map){}, struct Val, id,
                                        id_order, NULL, NULL, SMALL_FIXED_CAP);
