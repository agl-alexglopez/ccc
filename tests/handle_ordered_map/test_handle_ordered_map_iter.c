...
check_static_begin(iterator_check, Handle_ordered_map *s)
{
...
check_static_begin(handle_ordered_map_test_forward_iter)
{
...
check_static_begin(handle_ordered_map_test_iterate_removal)
{
...
check_static_begin(handle_ordered_map_test_iterate_remove_reinsert)
{
    CCC_Handle_ordered_map s = handle_ordered_map_initialize(
        &(standard_fixed_map){}, struct Val, id, id_order, NULL, NULL,
        STANDARD_FIXED_CAP);
...
check_static_begin(handle_ordered_map_test_valid_range)
{
    CCC_Handle_ordered_map s
        = handle_ordered_map_initialize(&(small_fixed_map){}, struct Val, id,
                                        id_order, NULL, NULL, SMALL_FIXED_CAP);
...
check_static_begin(handle_ordered_map_test_valid_range_equals)
{
    CCC_Handle_ordered_map s
        = handle_ordered_map_initialize(&(small_fixed_map){}, struct Val, id,
                                        id_order, NULL, NULL, SMALL_FIXED_CAP);
...
check_static_begin(handle_ordered_map_test_invalid_range)
{
    CCC_Handle_ordered_map s
        = handle_ordered_map_initialize(&(small_fixed_map){}, struct Val, id,
                                        id_order, NULL, NULL, SMALL_FIXED_CAP);
...
check_static_begin(handle_ordered_map_test_empty_range)
{
    CCC_Handle_ordered_map s
        = handle_ordered_map_initialize(&(small_fixed_map){}, struct Val, id,
                                        id_order, NULL, NULL, SMALL_FIXED_CAP);
