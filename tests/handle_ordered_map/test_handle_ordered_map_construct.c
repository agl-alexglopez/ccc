...
CHECK_BEGIN_STATIC_FN(handle_ordered_map_test_copy_no_allocate)
{
...
CHECK_BEGIN_STATIC_FN(handle_ordered_map_test_copy_no_allocate_fail)
{
...
CHECK_BEGIN_STATIC_FN(handle_ordered_map_test_copy_allocate)
{
    Handle_ordered_map src = handle_ordered_map_initialize(
...
CHECK_BEGIN_STATIC_FN(handle_ordered_map_test_copy_allocate_fail)
{
    Handle_ordered_map src = handle_ordered_map_initialize(
        NULL, struct Val, id, id_order, std_allocate, NULL, 0);
    Handle_ordered_map dst = handle_ordered_map_initialize(
    ...
    CCC_Result res = handle_ordered_map_copy(&dst, &src, NULL);
    CHECK(res != CCC_RESULT_OK, true);
    CHECK_END_FN({ (void)handle_ordered_map_clear_and_free(&src, NULL); });
}
