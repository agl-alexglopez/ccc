...
main()
{
    return CHECK_RUN(handle_ordered_map_test_empty(),
                     handle_ordered_map_test_copy_no_alloc(),
                     handle_ordered_map_test_copy_no_alloc_fail(),
                     handle_ordered_map_test_copy_alloc(),
                     handle_ordered_map_test_copy_alloc_fail());
}
