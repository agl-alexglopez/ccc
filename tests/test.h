...
#define CHECK(test_result, test_expected, format_specifier,                    \
              optional_free_on_fail...)                                        \
    do                                                                         \
    {                                                                          \
        ...
        {                                                                      \
            ...
            (void)fprintf(stderr, format_specifier, result_);                  \
            (void)fprintf(stderr, " ) != expected( ");                         \
            (void)fprintf(stderr, format_specifier, expected_);                \
            (void)fprintf(stderr, " )" CYAN "\n" NONE);                        \
